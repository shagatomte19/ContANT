                            ...
                            <div className="grid grid-cols-2 gap-2">
                                {[
                                    ...
                                    <button
                                        ...
                                        className={`flex items-center justify-center space-x-2 py-3 rounded-xl text-[10px] font-black uppercase border-2 transition-all font-heading ${
                                            demoFormat === fmt.id ? 'bg-slate-900 dark:bg-white text-white dark:text-slate-900 border-slate-900 dark:border-white' : 'bg-white dark:bg-slate-950 border-slate-100 dark:border-slate-800 text-slate-500'
                                        }`}
                                    >
